...
_maxVelocity(600.0f)
{
    Load("/Users/Anarchy/Library/Developer/Xcode/DerivedData/BitPaddle!-ejeslufbilzrwbbmfdafgxpfecar/Build/Products/Debug/../../../../../../../../Documents/Repository/BitPaddle!/BitPaddle!/images/paddle.png");
    assert(IsLoaded());
...
void AIPaddle::Update(float elapsedTime)
{
    ...
    (Game::GetGameObjectManger().Get("Ball"));
